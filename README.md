...
Для відкриття поточного рахунку (current account, "карент екаунт") завичай потрібно підтверження адреси (див. вище) та посвідчення особи, деталі уточнюйте у вашого банку на сайті або за телефоном. Можливо існують виключення для українців (наприклад NatWest пропонує [спеціальний рахунок](https://www.natwest.com/ukraine-refugees2.html)). Інколи приходиться йти в відділення, але також можна все оформили онлайн чи закачавши банківську програму на телефон.
...
При відкритті рахунку ви введете свої дані і банк перевірить вашу кредитну історію щоб прийняти рішення. Оскільки у вас може не бути історії в Британії, не засмучуйтесь якщо конкретний банк може відмовити, запитайте що вам робити (чи потрібні додаткові документи) або спробуйте інший банк. В крайньому випадку можна відкрити базовий рахунок (basic account, "бейсік екаунт"), банки зазвичай про нього не пишуть, вам треба запитати. Він безкоштовний (з мінімальними тарифами) і створений для людей з поганим кредитним рейтингом (це не про вас), більше інформації [тут](https://www.moneysavingexpert.com/banking/basic-bank-accounts/).
...
Сплата рахунків часто проводиться налаштуванням прямого дебетування (direct debit, "дайрект дебіт"), але це не єдиний спосіб сплати, зазвичай ви маєте вибір. При налаштування прямого дебетування, вказавши номер рахунку та сортувальний код ви дозволяєте компанії стягувати платежі (на різні суми) напряму з вашого рахунку.
...
Якщо ви маєте більше ніж £10,000 заощаджень то кожні £500 понад £10,000 будуть рахуватись як £1 доходу в тиждень.
