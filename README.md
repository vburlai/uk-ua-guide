...
Примітка: не переживайте якщо ви не можете дістати один з наведених вище документів. Більшість банків приймають інші документи (читайте на сайті банку, приклади наведені нижче) а деякі не потребують proof of address взагалі або лише для українців (наприклад NatWest, Halifax).
