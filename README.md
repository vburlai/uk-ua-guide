...
Примітка: про оформленні ви можете додатково отримати оплату за попередні 3 місяці.
...
Примітка: люди з [cерьозними](https://www.nhs.uk/nhs-services/prescriptions-and-pharmacies/who-can-get-free-prescriptions/) захворюваннями отримують картку на безкоштовні ліки.
...
[Оподаткування](https://www.gov.uk/income-tax-rates) залежить від персональних обставин, але часто виглядає так:
...
В кінці року буває перелата чи недоплата податків. Якщо переплатили, ви отримаєте чек на потрібну суму. Якщо недоплатили, податкова змінить ваш [податковий код](https://www.gov.uk/tax-codes/what-your-tax-code-means) (tax code, "текс коуд") зі стандартного 1257L (що означає 12,570 неоподаткованого personal allowance) на меншу суму і таким чином за наступний рік ви автоматично погасите цю заборгованість заплативши більше подадків щомісяця.

Примітка: Tax code для Шотландії починається з літери S.

Примітка: Благодійні організації різного типу можуть просити вас заповнити анкету на Gift Aid "гіфт ейд", ця анкета впливає на ваші податки, зберігайте інформацію про Gift Aid який ви подали.

Примітка: коли дохід більше £100,000, податкова може попросити вас заповнити декларацію (tax return, "текс рітьорн"), там буде розділ про Gift Aid.

Примітка: якщо ви пропрацювали не повний рік, після квітня податкова майже точно повинна вам повернути частину податків!

## Транспорт в Лондоні

Компанія [TfL](https://tfl.gov.uk), “ті-еф-ель”, Transport for London керує транспорною системою міста.

Приїзд оплачується спеціальною картою Oyster (яку можна придбати в автоматах на станціях метро) або звичайною банківською картою з безконтактним чіпом (contactless, "контактлес", наприклад Visa waive, MasterCard Paypass, Apple Pay, Google Pay). У Кожного з методів є свої плюси та мінуси, наприклад Oyster дозволяє краще контролювати ваші витрати, легко виправити невірний тариф прямо у працівників станції, купувати проїздні (travelcard, "тревелкард").

Примітка: можна користуватися карткою українського банку, але оплата буде конвертуватися з фунтів стерлінгів у гривню і цей курс може змінюватися.
...
Одноразовий проїзд досить дорогий, але існує ліміт (cap, "кеп") - максимальна сумма грошей, яка буде знята в день, тиждень (з пн по нд, приміняється лише для банківських карток) та місяць. На Oyster можна купити і "покласти" проїздний, який доступний на різні види траспорту і зони подорожей на день, тиждень, місяць і навіть рік.

"Кеп" ліміт [на автобус та трамвай](https://tfl.gov.uk/fares/find-fares/bus-and-tram-fares) (якщо не користуватися іншими видами транспорту):
...
Люди пенсійного віку (старші 67 років), що живуть в Лондоні можуть оформити [Freedom Pass](https://tfl.gov.uk/fares/free-and-discounted-travel/freedom-pass) ("фрідом пас"), що також надає безкоштовний проїзд по Лондону.

Якщо ви шукаєте роботу або отримуєте соціальні виплати, можна їздити на 50% дешевше з карткою [Jobcentre Plus Travel Discount](https://tfl.gov.uk/fares/free-and-discounted-travel/jobcentre-plus-travel-discount).
...
Примітка: завжди користуйтеся тією самою карткою для метро/проїздів, і не забувайте прикладати її на вході та виході, інакше буде застосований максимальний тариф (його можна оскаржити якщо відкрити рахунок на сайті TfL і додати туди ваші Oyster та банківські картки).
...
Примітка: при пересадці між метро та поїздами треба прикладати картку до спеціального рожевого рідера. Є декілька таких [пересадочних станцій](https://tfl.gov.uk/fares/how-to-pay-and-where-to-buy-tickets-and-oyster/pay-as-you-go/touch-pink-card-reader-when-changing-trains) між метро та поїздами (а саме Blackhorse Road, Canada Water, Clapham Junction, Ealing Broadway, Gospel Oak, Gunnersbury, Hackney Central/Hackney Downs, Highbury & Islington, Kensington (Olympia), Rayners Lane, Richmond, Stratford, Surrey Quays, West Brompton, Whitechapel, Willesden Junction, Wimbledon). На них встановлені рожеві карт рідери до яких треба прикласти Oyster/contactless при пересадці з/на поїзд. Цим ви вкажете, що не подорожували через зону 1 (центральні вокзали) і проїзд буде дешевшим. 

<img src="https://tfl.gov.uk/cdn/static/cms/images/pink-card-reader-explanation.jpg" width="50%" />

Аналогічно, існує ліміт "кеп" на максимальний тариф в день, тиждень (лише для банківських карт) і місяць, але він залежить від діапазону зон, між якими ви їздите. Також можна придбати проїздний на Oyster на день, тижень, місяць і рік для різних зон на ваш вибір.

Ліміти "кеп" та ціни проїздних можна подивитись [тут](https://tfl.gov.uk/fares/find-fares/tube-and-rail-fares/caps-and-travelcard-prices) ввівши початкову та кінцеву зону подорожей/проїздного.

Між зонами 1 та 3:
 * ліміт "кеп" в день £9
 * ліміт "кеп" для банківьских карток в тиждень (пн-нд) £45.20
 * місячний проїздний £173.60
 * річний проїздний £1808.00

Між зонами 2 та 4:
 * ліміт "кеп" в день £11 (на зони 1-4)
 * ліміт "кеп" для банківьских карток в тиждень (пн-нд) £31.90
