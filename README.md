 ...
 * Британська фото-картка водійські права (має містити вашу адресу)
   при оформленні водійських прав можна отримати тимчасову (provisional, "прозіжнал") картку до здавання екзаменів. Ця картка також приймається як підверження адреси.
